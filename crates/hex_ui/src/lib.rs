        ...
        fn statistics_drawer_restores_standard_layout_after_enlarged_ui() {
            ...
            assert!(
                snapshot
                    .nodes
                    .iter()
                    .all(|node| node.name != "Own Lattice Panel"),
                "the expanded drawer must be the inspector region's sole presentation owner"
            );
            ...
            app.world_mut()
                ...
                .statistics
                .as_mut()
                .expect("the fixture owns Lab statistics")
                .expanded = false;
            for _ in 0..8 {
                app.update();
            }
