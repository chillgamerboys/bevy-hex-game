...
in `hex_core`; `hex_combat` may later depend on the richer perception API for
detection, targeting, and last-known-position behavior. A lighting-profile adapter
