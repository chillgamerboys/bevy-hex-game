...
| Crystal Ascent authored landmark | Selectable radius-40 vertical biome with a monumental lower aperture, open heart chamber, three four-wide contracting stair circuits over 100–200 levels, eighteen crystal-lit landings, exact heart occupancy, and a woodland-clearing crown around the summit oculus |
