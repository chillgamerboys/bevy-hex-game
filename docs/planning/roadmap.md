...
| Outpost structure | The additive radius-12 Outpost scenario ships an east-facing gravel-courtyard fort with a terracotta central inlay and circulation paths, limestone walls, worked-stone trim and framed defensive slits, timber stairs and landings, slate floors/walks/roofs, twin enclosed nine-level-loop climbs, and open level-27 lookouts |
