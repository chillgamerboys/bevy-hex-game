...
| Coastal islands and Ocean Archipelagoes | **In progress:** the parallel island wave adds focused radius-24 Sandy Islets and radius-40 Wooded Island recipes plus a radius-77 Macro ocean with three scenic sandy clusters, one playable landing, and a six-cell wooded heart. Generator, composition, lifecycle, walk, and visual-review evidence are being assembled; no swimming or remote-island traversal mechanic is included | map / presentation |
