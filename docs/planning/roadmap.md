...
| Trajectories and lingering effects | exact `Direct`/`Arc`/`None` material trajectories now share one symmetric integer supercover across authoritative casting, preview, and AI; remaining work is area-unit resolution, area-lingering zones, dispel, and later sight reuse | combat | <!-- linear: HEX-24 owner: shravan-kumaran -->
