...
| Crystal Mountain and cross-biome tunnel | **In Progress / draft PR #210:** implementation is published but the macOS build and exact-head human presentation, motion, control-feel, and play review remain. It is the base of the biome delivery stack and must land before #211 | map / presentation |
| Arid biomes and Desert Oasis Rings | **In Progress / draft PR #211:** implementation is stacked on #210. Map tests completed, but the obsolete numeric partition assertion failed and the macOS build was cancelled; identity-based selection, current-base CI, and exact-head Desert/Oasis review remain | map / presentation |
| Coastal islands and Ocean Archipelagoes | **In Progress / draft PR #212:** the former head is automated-green but remains stacked on #211 and lacks named-human presentation, motion, control-feel, and play approval | map / presentation |
| Corrective biome feedback | **In Progress / draft PR #213:** geometry and review corrections are stacked on #212. Map tests completed before the obsolete numeric partition assertion failed; exact-head cross-biome native flicker review remains | map / presentation |
| Grand V3 schematic and map compiler | **Implementation in progress / unpublished:** committed planner, compiler, and final-baseline checkpoints exist above the exact #213 head, while renderer-memory, combined CI, visual, motion, and human review gates remain open. Dirty route, time-cycle, and visual experiments are separate work, not part of the committed checkpoint | map / presentation |
