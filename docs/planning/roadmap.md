...
| Grand V3 schematic planner | **In Progress:** add a pure deterministic radius-eight planner and CLI with 217 layered coarse cells, exact authored landmarks and networks, bounded biome envelopes, seeded coastline/island/woodland variation, strict RON, semantic fingerprints, and diagnostic SVG/HTML galleries. Voxel terrain compilation and scale/palette experiments follow as separate phases | map |
