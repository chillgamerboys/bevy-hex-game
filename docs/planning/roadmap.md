...
| Grand V3 combined map completion | **In Progress / PR #219 candidate:** combine accepted visuals, the six recovered geometry fixes and Crystal crown snow with the pending grounded-exploration handoff. Preserve original routes; complete strict generation/corpora, selector and runtime checks, final captures, animation/native-play evidence and same-map morning launchers. Historical measurements remain in the Grand V3 manifests and do not certify this head. | map / presentation |
