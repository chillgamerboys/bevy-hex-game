# L5: Resident stock object presentation

Authority: shared. Builder: worker in `feat/v4-object-presentation`. Coordinator: root V4 task.

Implement only [crates/hex_objects/src/v4]. Consume the shared V4 package and exact query contracts.
