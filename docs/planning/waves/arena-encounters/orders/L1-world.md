# Authored world and material admission

Authority: world. Read [plan](../plan.md), [manifest](../manifest.md), [seams](../maps/seams.md). Manifest decisions 1–5 apply verbatim. Discrepancies go to root; do not cross ownership. Root sends foundation-ready signal. No commits, branch changes, builds, remote actions or visible windows without coordinator scheduling.
