...
| Default-off `MultiplayerPlugin` with Replicon/Aeronet/WebTransport | shared composition | explicit Host Direct / Join Direct runtime | **live** — custom auth, audited SPKI-pinned direct transport, player-facing endpoint/lobby orchestration, and socket-free offline defaults ship together | [client-hosted sandbox manifest](planning/waves/client-hosted-sandbox/manifest.md) |
