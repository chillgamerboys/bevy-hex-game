...
| `HostCampaignCheckpointV2` | shared stable checkpoint vocabulary; world/gameplay adapters remain owner-specific | host-owned Campaign persistence only | **foundation** — complete world, unit, lattice, effect-ledger, formation, rules/seeds, and active-time shape is bounded and transport-neutral; export/import and save lifecycle are the planned Campaign wave | [host-owned Campaign manifest](planning/waves/host-owned-campaign/manifest.md) |
